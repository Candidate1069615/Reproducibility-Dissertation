...
CoxShi <- function(Q, ind, p_min, p_max, J, K, B, test_type = "two_sided"){
  if (test_type == "one_sided") {
    B0 = Bound0_1s(p_max, J)
    B1 = Bound1_1s(p_max, J)
    B2 = Bound2_1s(p_max, J)
  } else {
